    ...
    with app.app_context():
        try:
            ...
            if not User.query.first():
                ...
                if not c1:
                    c1 = College(id=1, name="El'Wood International School", code="EWIU", address="14 Greenwood Avenue, Education City")
                    db.session.add(c1)
                ...
                if not c2:
                    c2 = College(id=2, name="Sunrise Academy", code="SRA", address="88 Sunrise Boulevard, Metro District")
                    db.session.add(c2)
                ...
                for r_role, r_name, r_email, r_pwd in demo_accounts:
                    ...
                    if not u:
                        u = User(name=r_name, email=r_email, role=r_role, college_id=target_cid)
